...
ENV CONF_HOME=/var/atlassian/confluence \
    ...
    CONF_VERSION=6.14.1 JAVA_OPTS='-Duser.timezone=GMT+08'
...
COPY atlassian-extras-3.4.1.jar  ${CONF_INSTALL}/confluence/WEB-INF/lib/atlassian-extras-decoder-api-3.4.1.jar
